    ...
    <div className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-4 py-10">
      ...
      <div className="mt-6 grid gap-2 text-center text-[11px] text-muted-foreground">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          <code className="rounded-lg bg-white/[0.04] px-2 py-1">levent@example.com</code>
          <code className="rounded-lg bg-white/[0.04] px-2 py-1">admin.north@example.com</code>
        </div>
        <p>Password: <code className="rounded-lg bg-white/[0.04] px-2 py-1">Test1234!</code></p>
      </div>
    </div>
  );
}
